(function (jQuery) {
  ...
  jQuery('.contato').on('submit', function (e) {
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        body.addClass('lightbox-open');
		window.ga("send", "event", "contato", "enviado", "enviado"); //envio para o google analytics, tenho duvidas em como fazer essa parte de forma elegante
		console.log("INPUT GA ENVIADO")
